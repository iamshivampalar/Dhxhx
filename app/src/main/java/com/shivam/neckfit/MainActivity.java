...
public class MainActivity extends Activity {
    ...
    void seedExercises(){
        exercises.add(new Exercise("Chin Tuck", "चिन टक", "Forward head correction", 30, 2, R.drawable.anim_chin_tuck,
        ...
        exercises.add(new Exercise("Shoulder Blade Squeeze", "शोल्डर ब्लेड स्क्वीज", "Upper back activation", 30, 2, R.drawable.anim_shoulder_squeeze,
        ...
        exercises.add(new Exercise("Neck Side Stretch", "नेक साइड स्ट्रेच", "Side neck release", 20, 2, R.drawable.anim_side_stretch,
        ...
        exercises.add(new Exercise("Neck Flexion Stretch", "नेक फ्लेक्शन", "Back neck relaxation", 20, 2, R.drawable.anim_flexion,
        ...
        exercises.add(new Exercise("Wall Posture Hold", "वॉल पोस्टर होल्ड", "Full-body alignment", 45, 2, R.drawable.anim_wall_hold,
        ...
        exercises.add(new Exercise("Chest Opener Stretch", "चेस्ट ओपनर", "Rounded shoulder fix", 30, 2, R.drawable.anim_chest_opener,
        ...
        exercises.add(new Exercise("Phone Posture Practice", "फोन पोस्टर प्रैक्टिस", "Daily habit correction", 60, 1, R.drawable.anim_phone_posture,
    ...
    void startIllustration(ImageView img){
        try{
    ...
    void showExercises(){
        ...
        for(Exercise e: exercises){
            LinearLayout c = card();
            ImageView img = new ImageView(this); img.setImageResource(e.image); startIllustration(img); img.setAdjustViewBounds(true); img.setScaleType(ImageView.ScaleType.CENTER_CROP); c.addView(img, new LinearLayout.LayoutParams(-1, dp(165)));
    ...
    void showWorkoutExercise(){
        ...
        LinearLayout c = card();
        ImageView img = new ImageView(this); img.setImageResource(e.image); startIllustration(img); img.setAdjustViewBounds(true); img.setScaleType(ImageView.ScaleType.CENTER_CROP); c.addView(img, new LinearLayout.LayoutParams(-1, dp(178)));
